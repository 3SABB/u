...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/SiKOOO/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
end 
if text == "تحديث" then
...
bot.sendText(msg.chat_id,msg.id," ♕يح كمزتني بدخولك🦦💞 .*"..Usertag..".","md")  
end
end
end
...
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "عصب") then
...
bot.sendText(msg.chat_id,msg.id,"*♕انت دخلت من الرابط لتلح .*","md",true) 
return false
end
end
if Constructor(msg) then
...
bot.sendText(msg.chat_id,msg.id,"*نجب ولك تريد اهين تاج راسك*","md", true)
return false
end
