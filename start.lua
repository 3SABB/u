...
var = redis:get(bot_id..":Reply:Creator"..chat_id) or "الرئيس"  
...
reply_markup = reply_markup
t = "*- اوامر اخرى .\n *  ٴ— — — — — — — — — — —  *\n- الالعاب الاحترافيه .\n- المجموعه .\n- الرابط .\n- اسمي .\n- ايديي .\n- مسح نقاطي .\n- نقاطي .\n- مسح رسائلي .\n- رسائلي .\n- مسح جهاتي .\n- مسح بالرد .\n- تفاعلي .\n- جهاتي .\n- مسح سحكاتي .\n- سحكاتي .\n- رتبتي .\n- معلوماتي .\n- الرائد .\n- رفع الرائد .\n- البايو/نبذتي .\n- التاريخ/الساعه .\n- رابط الحذف .\n- الالعاب .\n- منع بالرد .\n- منع .\n- تنظيف + عدد .\n- قائمه المنع .\n- مسح قائمه المنع .\n- مسح الاوامر المضافه .\n- الاوامر المضافه .\n- ترتيب الاوامر .\n- اضف امر .\n- حذف امر .\n- اضف رد .\n- حذف رد .\n- ردود النقيب .\n- مسح ردود النقيب .\n- الردود المتعدده .\n- مسح الردود المتعدده .\n- وضع عدد المسح +رقم .\n- مسح البوتات .\n- ٴall .\n- غنيلي، فلم ، متحركه ، رمزيه ، فيديو .\n- تغير رد المواطن ، الجندي ، الملازم ، النقيب ، الرائد ، الرائد الاساسي. الرئيس ، المطور .\n- حذف رد المواطن ، الجندي ، الملازم ، النقيب ، الرائد الرائد الاساسي ، الرئيس المطور .*"
...
x = x + 1
bot.sendText(Get_Chat.id,0,'*- البوت ليس ملازم في المجموعه*',"md")
...
redis:set(bot_id..":"..msg.chat_id..":Command:رس","رفع رائد اساسي")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"رس")
redis:set(bot_id..":"..msg.chat_id..":Command:ر","رفع رائد")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"ر")
redis:set(bot_id..":"..msg.chat_id..":Command:ن","رفع نقيب")
redis:sadd(bot_id.."List:Command:"..msg.chat_id,"ن")
redis:set(bot_id..":"..msg.chat_id..":Command:م","رفع ملازم")
...
bot.sendText(msg.chat_id,msg.id,"*- اوامر اخرى .\n *  ٴ— — — — — — — — — — —  *\n- الالعاب الاحترافيه .\n- المجموعه .\n- الرابط .\n- اسمي .\n- ايديي .\n- مسح نقاطي .\n- نقاطي .\n- مسح رسائلي .\n- رسائلي .\n- مسح جهاتي .\n- مسح بالرد .\n- تفاعلي .\n- جهاتي .\n- مسح سحكاتي .\n- سحكاتي .\n- رتبتي .\n- معلوماتي .\n- الرائد .\n- رفع الرائد .\n- البايو/نبذتي .\n- التاريخ/الساعه .\n- رابط الحذف .\n- الالعاب .\n- منع بالرد .\n- منع .\n- تنظيف + عدد .\n- قائمه المنع .\n- مسح قائمه المنع .\n- مسح الاوامر المضافه .\n- الاوامر المضافه .\n- ترتيب الاوامر .\n- اضف امر .\n- حذف امر .\n- اضف رد .\n- حذف رد .\n- ردود النقيب .\n- مسح الردود المتعدده .\n- الردود المتعدده .\n- وضع عدد المسح +رقم .\n- ٴall .\n- غنيلي،فلم، متحركه، فيديو، رمزيه،انمي،ريمكس،شعر،ميمز،راب .\n- مسح ردود النقيب .\n- تغير رد المواطن.الجندي.الملازم.النقيب.الرائد.الرائد الاساسي.الرئيس.المطو  .\n- حذف رد المواطن.الجندي.الملازم.النقيب.الرائد.الرائد الاساسي.الرئيس.المطور .*","md",true)
...
if text == 'رفع الرائد' or text == 'رفع الرئيس' then
...
if text == 'الرائد' or text == 'الرئيس' then
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*- البوت لا يمتلك صلاحيه .*","md",true)  
return false
end
...
return bot.sendText(msg.chat_id,msg.id,"*- تم تعطيل امسح بواسطه الرئيس .*","md",true)  
end
...
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*- البوت ليس ملازم في المجموعه .*","md",true)  
return false
end
if GetInfoBot(msg).Delmsg == false then
...
elseif text and text:match("^تغير رد الرئيس (.*)$") then
local Teext = text:match("^تغير رد الرئيس (.*)$") 
...
elseif text == 'حذف رد الرئيس' then
redis:del(bot_id..":Reply:Creator"..msg.chat_id)
bot.sendText(msg.chat_id,msg.id,"*- تم "..text.." بنجاح .*", 'md')
...
--
if text == 'تفعيل الردود' or text == 'تفعيل ردود النقيب' then
...
if text == 'تعطيل الردود' or text == 'تعطيل ردود النقيب' then
...
if text == 'الرئيسين' then
t = '\n*- قائمه '..text..'  \n ٴ ٴ— — — — — — — — — — — — *\n'
local Info_ = redis:smembers(bot_id..":"..msg.chat_id..":Status:Creator") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*- لا يوجد الرئيسين*").yu,"md",true)  
return false
end  
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
if text == 'مسح الرئيسين' and developer(msg) then
local Info_ = redis:smembers(bot_id..":"..msg.chat_id..":Status:Creator") 
if #Info_ == 0 then
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender.user_id,"*- تم حذف "..text:gsub('مسح',"").." سابقا .*").yu,"md",true)  
return false
...
if redis:get(bot_id..":"..msg.chat_id..":Features") then
return bot.sendText(msg.chat_id,msg.id,"*- تم تعطيل الجنديات بواسطه المدراء .*","md",true)  
end
keyboard = {} 
...
if text == "ون نقيب" or text == "وين نقيب" then
if redis:get(bot_id..":"..msg.chat_id..":Rdodbot") then
return bot.sendText(msg.chat_id,msg.id,"md",true)  
end
...
if text == 'تفعيل' then
if msg.can_be_deleted_for_all_users == false then
bot.sendText(msg.chat_id,msg.id,"*- عذراً البوت ليس ملازم في المجموعه .*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id,"*- عذراً يجب أنْ تكون مشرف او رئيس المجموعه .*","md",true)  
return false
end
end
if sm.status.luatele == "chatMemberStatusCreator" then
...
if not developer(msg) then
if sm.status.luatele ~= "chatMemberStatusCreator" then
bot.sendText(msg.chat_id,msg.id,"*- عذراً يجب أنْ تكون رئيس المجموعه فقط .*","md",true)  
return false
end
end
if redis:sismember(bot_id..":Groups",msg.chat_id) then
